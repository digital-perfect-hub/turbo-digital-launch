...
export const defaultSiteText: Record<string, string> = {
  ...
  home_intro_cta_link: "#seo-pakete",
  ...
  home_services_title: "Strategie, Technik und Umsetzung aus einer Hand.",
  home_services_description:
    "Neben den festen Paketen entwickeln wir saubere digitale Systeme für Webdesign, SEO, KI-Sichtbarkeit, Conversion und Automatisierung.",
  home_seo_packages_kicker: "SEO & KI Sichtbarkeit",
  home_seo_packages_title: "Pakete für Unternehmen, die gefunden und empfohlen werden wollen.",
  ...
  home_webdesign_packages_kicker: "Webdesign Pakete",
  home_webdesign_packages_title: "Websites, die Vertrauen aufbauen und Anfragen leichter machen.",
  ...
  home_process_title: "In vier klaren Schritten zu mehr Sichtbarkeit und einer Website, die Anfragen bringt.",
  ...
  home_hero_secondary_cta_text: "Pakete ansehen",
  home_hero_secondary_cta_link: "#seo-pakete",
