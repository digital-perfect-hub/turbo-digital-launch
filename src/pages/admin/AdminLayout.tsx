...
import { LayoutDashboard, ImageIcon, Package, MessageSquare, Settings, Type, HelpCircle, LogOut } from "lucide-react";
    ...
    <div className="min-h-screen flex bg-background">
      <aside className="w-60 border-r border-border bg-card flex flex-col">
        ...
        <div className="p-2 border-t border-border">
          <button onClick={() => { signOut(); navigate("/"); }} className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-muted-foreground hover:text-destructive w-full">
