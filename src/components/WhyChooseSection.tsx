          ...
          <div className="grid content-start gap-6 sm:gap-8 md:grid-cols-2">
            {points.map((point, index) => (
              <motion.div
                ...
                className="dp-blue-card-border dp-blue-card-surface group relative flex h-full flex-col overflow-hidden rounded-[2rem] border-2 border-[#0a1842] bg-[#FAF6EE] p-8 shadow-none transition-all duration-500 hover:-translate-y-1 hover:shadow-none"
              >
